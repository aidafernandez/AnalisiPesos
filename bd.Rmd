...
```{r fig.height=4, fig.width=8}
histComparatius(pesInd,1,8,1,20,"difBW41_28") +
histComparatius(pesInd,1,8,1,20,"indexBW41_28") +
histComparatius(pesInd,1,8,1,20,"taxBW41_28")
```
...
p <- list(numeric(7))
for(i in 1:7){
  p[[i]] <- histComparatius(pesInd,1,i+1,1,20,"difBW41_28")
}
...
quantile(subset(pesInd,Treat == 2)$difBW41_28, c(0.25,0.75), na.rm = T)
  
histComparatius(pesInd, 1, 2, 1, var = "difBW41_28")
